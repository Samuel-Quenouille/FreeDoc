...
ActiveRecord::Schema[7.0].define(version: 2023_05_04_190135) do
  ...
  add_foreign_key "join_table_specialty_doctors", "doctors"
  add_foreign_key "join_table_specialty_doctors", "specialties"
